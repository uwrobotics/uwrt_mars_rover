...
#include "uwrt_mars_rover_xbox_controller/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _XboxController_type_support_symbol_names_t _XboxController_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, uwrt_mars_rover_xbox_controller, msg, XboxController)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uwrt_mars_rover_xbox_controller, msg, XboxController)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_uwrt_mars_rover_xbox_controller
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, uwrt_mars_rover_xbox_controller, msg, XboxController)() {
  return &::uwrt_mars_rover_xbox_controller::msg::rosidl_typesupport_c::XboxController_message_type_support_handle;
}
